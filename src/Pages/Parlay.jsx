...
//Test Functions:
import { 
    getTeamGames, getTeamRoster,
    getTeamStandings, getTeamStats, getPlayerIds
...
const Parlay = () => {
    ...
    const testAPI = async() => {
        await getTeamStats(1);
        await getTeamGames(1);
        await getTeamRoster(1);
        await getTeamStandings(1);
    }
